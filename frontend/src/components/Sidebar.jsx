...
const Sidebar = () => {
    ...
    return (
        <aside className='h-screen bg-base-200 border-r border-base-300 hidden lg:flex w-64 flex-col sticky top-0'>
            ...
            <nav className='flex-1 p-4 space-y-1'>
                <Link
                    to="/"
                    className={`btn btn-ghost justify-start w-full gap-3 px-3 normal-case ${currentPath === "/" ? "btn-active" : "btn-disabled"}`}
                >
                ...
                <div className='flex items-center gap-3'>
                    <div className='avatar'>
                        <div className='w-10 rounded-full'>
                            <img src={authUser?.profilePic} alt="Profile Picture Avatar" />
                        </div>
                    </div>
